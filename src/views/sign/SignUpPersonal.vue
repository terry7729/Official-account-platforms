<template>
  <el-row>
    ...
    <el-col :xs="14" :sm="14" :md="14" :lg="12" :xl="10" class="pt-30 pb-30 pl-40 pr-40 shadow" style="background: #fff;">
      ...
      <el-form class="mt-20" :model="forms" :rules="rules" ref="form" label-width="100px" hide-required-asterisk @validate="handleValidate">
        <el-form-item label="公众号名称" prop="name" :error="error.name">
        ...
        if(res.code === 0) {
          ...
          switch(res.code) {
            case 4:
              ...
              break
            case 2:
              this.$refs.form.$children[4].$el.children[1].children[1].style.display = 'none'
